...
const CONTRASENA = "231124"; // Cambia esto por la contraseña que desees
...
function actualizarContador() {
    const fechaInicio = new Date('2024-11-23'); // Cambia esta fecha por la que desees
...
document.addEventListener("DOMContentLoaded", function () {
    const images = document.querySelectorAll(".fotos .clickable");
    ...
    // Cerrar modal al hacer clic fuera de la imagen o en el botón de cerrar
...
/* */
// Función para volver a la sección "Nuestro Tiempo Juntos" y mostrar el contador
function volverTiempoJuntos() {
    const seccionContador = document.getElementById('seccion-contador');
    const seccionGaleria = document.getElementById('seccion-galeria');
    const seccionCarta = document.getElementById('seccion-carta');
    const container = document.querySelector('.container'); // Contenedor principal del contador
    ...
    seccionContador.style.display = 'block';
    container.style.display = 'none'; // Asegurar que el contenedor del contador esté visible
}
